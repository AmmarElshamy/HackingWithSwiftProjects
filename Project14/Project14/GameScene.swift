...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        for i in 0...3 { createSlot(at: CGPoint(x: 180 + (i * 170), y: 320)) }
        for i in 0...4 { createSlot(at: CGPoint(x: 100 + (i * 170), y: 230)) }
        for i in 0...3 { createSlot(at: CGPoint(x: 180 + (i * 170), y: 140)) }
    ...
    func creatPenguin() {
        ...
        if numRounds > 30 {
            ...
            finalScore.position = CGPoint(x: 512, y: 8)
